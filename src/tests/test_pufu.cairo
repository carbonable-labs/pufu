...
mod test {
    ...
    use super::super::super::interfaces::comde::{IComdeDispatcher, IComdeDispatcherTrait};
    ...
    fn setup() -> (IComdeDispatcher, IERC721Dispatcher, ContractAddress, ContractAddress) {
